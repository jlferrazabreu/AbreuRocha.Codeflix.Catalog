...
using UseCase = AbreuRocha.Codeflix.Catalog.Application.UseCases.Genre.CreateGenre;
using Moq;
using Xunit;
...
public class CreateGenreTest
{
    ...
    [Fact(DisplayName = nameof(CreateThorwWhenRelatedCategoryNotFound))]
    [Trait("Application", "CreateGenre - Use Cases")]
    public async void CreateThorwWhenRelatedCategoryNotFound()
    {
        var input = _fixture.GetExampleInputWithCategories();
    ...
    [Theory(DisplayName = nameof(ThorwWhenNameIsInvalid))]
    [Trait("Application", "CreateGenre - Use Cases")]
    [InlineData("")]
    [InlineData("   ")]
    [InlineData(null)]
    public async void ThorwWhenNameIsInvalid(string name)
    {
